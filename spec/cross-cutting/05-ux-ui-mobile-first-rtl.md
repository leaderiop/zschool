...
Screen terminology follows `spec/glossary.md`: *student* (*تلميذ(ة)*), *teacher* (*أستاذ(ة)*), *class* (*القسم*), *report card* (*بيان النقط*), *timetable* (*استعمال الزمن*), *absence* (*غياب*), *tardiness* (*تأخر*), *justification* (*مبرر الغياب*), *arrears* (*متأخرات الأداء*), *receipt* (*وصل الأداء*), *Massar code* (*رمز مسار*). No floating synonyms: one concept = one term = one FR and AR label.
