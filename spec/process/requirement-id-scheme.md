...
| `RDM-ZS-NNN` | Roadmap milestone (renamed from the old `JAL-NN` — _jalons_ — since that code was never declared opaque/stable in the PRD's own conventions, unlike module/persona/NFR-domain/integration-system codes)                                   | `roadmap.md`                                                                                                                               | 001–  |
